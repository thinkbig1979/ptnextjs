...
export function PartnersDisplay({ partners, categories }: PartnersDisplayProps) {
  ...
  const filteredPartners = React.useMemo(() => {
    ...
    return filtered;
  }, [partners, searchQuery, selectedCategory, highlightedPartner]);

  // Get products by partner (client-side filtering)
  const getProductsByPartner = React.useCallback((partnerId: string) => {
    // Since we don't have products data here, we'll simulate it
    // In a real implementation, you'd pass products as props too
