...
import { ClipboardCheck, FileText, CheckSquare, Headphones, ArrowRight } from "lucide-react";

export const metadata: Metadata = {
  title: "Project Consultancy | Paul Thames",
  description: "Technical clarity for owners, designers, and shipyards at critical decision points. Specification review, creation, and on-demand support for superyacht projects.",
};
        ...
        <div className="mb-20">
          <div className="bg-accent/10 border border-accent/20 rounded-2xl p-8 md:p-12 text-center">
            ...
            <p className="text-lg text-muted-foreground font-poppins-light max-w-2xl mx-auto">
              Early project phases where decisions have the biggest impact and corrections cost the least.
            </p>
          </div>
        </div>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto font-poppins-light">
              The earlier the involvement, the greater the impact. But support is available at any stage.
            </p>
          </div>
        ...
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {services.map((service) => (
              <Card key={service.title} className="h-full border-accent/10 hover:border-accent/30 transition-colors">
                <CardHeader>
                  <div className="flex items-center mb-4">
                    ...
                    <CardTitle className="text-xl md:text-2xl font-cormorant text-accent">{service.title}</CardTitle>
                  </div>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-3">
                    <div className="flex items-start">
                      <span className="text-foreground font-poppins-medium text-sm min-w-[4rem]">What:</span>
                      <span className="text-muted-foreground font-poppins-light text-base ml-2">{service.what}</span>
                    </div>
                    <div className="flex items-start">
                      <span className="text-foreground font-poppins-medium text-sm min-w-[4rem]">For:</span>
                      <span className="text-muted-foreground font-poppins-light text-base ml-2">{service.who}</span>
                    </div>
                    <div className="flex items-start">
                      <span className="text-foreground font-poppins-medium text-sm min-w-[4rem]">When:</span>
