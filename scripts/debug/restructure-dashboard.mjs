...
const dashboardPath = '/home/edwin/development/ptnextjs/app/(site)/vendor/dashboard/page.tsx';
...
try {
  fs.writeFileSync(dashboardPath, newContent, 'utf-8');
  console.log('Successfully restructured dashboard!');
} catch (error) {
