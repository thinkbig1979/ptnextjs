/**
 * Script to add real location data to vendors in Payload CMS
 * Uses actual addresses with valid coordinates for testing
 */
...
const vendorLocations = [
  {
    // Fort Lauderdale - major yachting hub
  ...
  {
    // Miami - another major yachting location
  ...
  {
    // Barcelona - major Mediterranean port
  ...
  {
    // Newport, Rhode Island - classic American yachting
  ...
  {
    // Seattle - Pacific Northwest yachting
