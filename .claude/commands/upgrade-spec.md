...
- Fresh codebase analysis and integration intelligence
...
**Use enhance-existing when:** You just want to add validation requirements to existing content.

Refer to the instructions located in this file:
@.agent-os/instructions/core/upgrade-spec.md
