...
# This file provides guidance for the security review workflow phase.
# It is NOT a callable Claude Code agent.
#
# Usage: The general-purpose agent loads this file when
# entering the security review phase of task execution.

role: security-sentinel
description: "Security analysis, vulnerability scanning, and OWASP compliance phase"
